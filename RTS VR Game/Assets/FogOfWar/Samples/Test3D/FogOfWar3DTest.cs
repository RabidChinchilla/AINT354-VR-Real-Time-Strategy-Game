...
namespace FoW
{
    ...
    public class FogOfWar3DTest : MonoBehaviour
    {
        ...
        public FogOfWarMinimap minimap;
        ...
        void OnTeamChanged()
        {
            ...
            FogOfWarLegacy fow = mainCamera.GetComponent<FogOfWarLegacy>();
            if (fow != null)
                fow.team = team;
            else
                Debug.LogError("Changing teams in demo only works with legacy renderer!");
