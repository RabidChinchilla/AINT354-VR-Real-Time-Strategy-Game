...
public class AICommander : MonoBehaviour {
    ...
    /// <summary>
    /// Adds a new unit to the list of AI disposable units.
    /// </summary>
    ...
    /// <summary>
    /// Gets the gameObject list representing each of the AI controlled units.
    /// </summary>
    /// <returns></returns>
    public List<GameObject> GetAIUnits()
    {
        List<GameObject> aiUnits = new List<GameObject>();

        foreach(var npcUnit in _availableUnits)
        {
            aiUnits.Add(npcUnit.Unit);
        }
    ...
    /// <summary>
    /// Invoked when loading games, this deletes all AI units.
    /// </summary>
    public void ClearAIUnits()
    {
        foreach (var npcUnit in _availableUnits)
        {
            Destroy(npcUnit.Unit);
        }
