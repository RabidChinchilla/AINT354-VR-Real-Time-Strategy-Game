...
public class StructureController : UnitController {
    ...
    private void Awake()
    {
        ...
        availableActions[(int)Constants.UnitAction.Attack] = ((StructureProperties)UnitProperties).canShoot;
        availableActions[(int)Constants.UnitAction.Mine] = true;
    ...
    protected void Start()
    {
        ...
        _unitData = (StructureProperties)UnitProperties;
